...
def train_one_epoch(train_dataloader: torch.utils.data.DataLoader,
...
def valid_one_epoch(valid_dataloader: torch.utils.data.DataLoader,
                    model: torch.nn.Module,
                    loss: torch.nn.Module):
    """
...
def optimize(data_loaders: Dict[str, torch.utils.data.DataLoader],
             model: torch.nn.Module,
             optimizer: torch.optim.Optimizer,
             loss: torch.nn.Module,
             n_epochs: int,
